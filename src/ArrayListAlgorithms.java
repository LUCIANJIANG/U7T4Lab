...
public class ArrayListAlgorithms {
    ...
    public static void wackyVowels(ArrayList<String> wordList)
    {
        for (int i = 0; i < wordList.size(); i++)
        {
            ...
            boolean ifContainsVowel = (word.indexOf("a") != -1 || word.indexOf("e") != -1 || word.indexOf("i") != -1
            || word.indexOf("o") != -1);
    ...
    public static void removeDuplicates(ArrayList<Integer> intList)
    {
        for (int i = 0; i < intList.size(); i++)
        {
            ...
            {
                if (intList.get(i) == intList.get(a))
                {
                    intList.remove(a);
                    a--;
                }
    ...
    public static ArrayList<String> parseWordsAndReverse(String sentence)
    {
        ...
        while (newSentence.indexOf(" ") != -1)
        {
            ...
            String word = newSentence.substring(0, index);
            list.add(0, word);
            newSentence = newSentence.substring(index + 1);
        }
        list.add(0, newSentence);
        return list;
    }
    ...
    public static void moveBWords(ArrayList<String> wordList)
    {
        ...
        for (int i = 0; i < wordList.size(); i++)
        {
            if (wordList.get(i).contains("b"))
            {
                ...
                wordList.add(nextIndex, removed);
                nextIndex++;
            }
        }
    }
